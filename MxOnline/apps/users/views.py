    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            if Userprofile.objects.filter(email=user_name):
                ...
                user_profile.save()
                # 写入欢迎注册消息
                user_messgae=UserMessage()
                user_messgae.user=user_profile.id
                user_messgae.message=u'欢迎注册慕学在线网'
                user_messgae.save()
...
class SendEmailCodeView(LoginRequiredMixin,View):
    ...
    def get(self,request):
        ...
        if Userprofile.objects.filter(email=email):
            return HttpResponse("{'email':u'邮箱已经存在'}",content_type='application/json')
...
class UpdateEmailView(View):
    ...
    def post(self,request):
        ...
        if existed_records:
            ...
            return HttpResponse("{'email':u'验证码出错'}",content_type='application/json')
...
class MyFavCourseView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        for fav_course in fav_courses:
            courese_id = fav_course.fav_id
            course = Course.objects.get(id=courese_id)
...
class MyMessageView(LoginRequiredMixin,View):
    def get(self,requset):
        ...
        all_messages=UserMessage.objects.filter(user=requset.user.id)
        ...
        p = Paginator(all_messages, 3, request=requset)
